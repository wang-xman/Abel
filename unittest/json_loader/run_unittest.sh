...
echo "******************************************"
echo "* Abel : Unittest : Header : json_loader *"
echo "******************************************"
...
g++ -std=c++14 -g -Wall -c ./test_json_loader.cpp -o ./test_json_loader.o -I $INCDIR -I $DORA_HEADER
...
g++ -std=c++14 -g -Wall \
    ...
    ./test_json_loader.o -L$DORA_LIBPATH \
    -o ./unittest_json_loader.out -ldora

echo "-- Run executable --"
./unittest_json_loader.out
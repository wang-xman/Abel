...
echo "******************************************"
echo "* Abel : Unittest : Header : json_parser *"
echo "******************************************"
...
g++ -std=c++14 -g -Wall -c ./test_json_parser.cpp -o ./test_json_parser.o -I $INCDIR -I $DORA_HEADER
...
g++ -std=c++14 -g -Wall \
    ...
    ./test_json_parser.o -L$DORA_LIBPATH \
    -o ./unittest_json_parser.out -ldora

echo "-- Run executable --"
./unittest_json_parser.out
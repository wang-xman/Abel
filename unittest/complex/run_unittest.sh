...
echo "**************************************"
echo "* Abel : Unittest : Header : complex *"
echo "**************************************"
...
g++ -std=c++14 -g -Wall -c ./test_complex.cpp -o ./test_complex.o -I $INCDIR -I $DORA_HEADER
...
g++ -std=c++14 -g -Wall \
    ...
    ./test_complex.o  \
    -L$DORA_LIBPATH \
    -o ./unittest_complex.out -ldora

echo "-- Run executable --"
./unittest_complex.out